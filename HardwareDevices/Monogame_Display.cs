...
public partial class Monogame_Display : VisualizableHardware, IDrawable
{
    ...
    public Monogame_Display(FrameBuffer frameBuffer)
    {
    ...
    public void LoadContent(GraphicsDevice graphics, ContentManager content, Game game)
    {
        ...
        //_imGuiRenderer = new ImGuiRenderer(_w);
        ...
        //_imGuiController = new ImGuiController(null, null);
